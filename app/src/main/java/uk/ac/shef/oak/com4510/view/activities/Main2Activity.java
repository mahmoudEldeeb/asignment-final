...
public class Main2Activity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // check if the phone has camera or not
                if(hasCamera()) {
                    //  check permissions
    ...
    /**
     * ask permission request results of use camera , gallery and location
     * @param requestCode
     * @param permissions
     * @param grantResults
     */
    ...
    /**
     * show option to choose image from gallery or take photo using camera
     */
    ...
    /**
     *  open the gallery to choose image from the gallery
     */
    ...
    /**
     *  this function called when choose an image from gallery or camera
     * @param requestCode
     * @param resultCode
     * @param data
     */
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(visitId==0) {
            // here we must put longitude and latitude in the visit so that I check location (it can not be null)
            if(myLocation!=null) {
    ...
    /**
     * I create object from VisitImage and add it to the list
     * @param myBitmap
     */
