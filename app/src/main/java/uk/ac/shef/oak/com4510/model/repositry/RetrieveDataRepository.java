...
/**
 *  this class used to retrieve data from database, and I get instance from visitdao to connect with room database
 * @author Areej
 */
public class RetrieveDataRepository {

    /**
     * I get instance from visitdao to connect with room database
     * @return VisitDao
     */
    ...
    /**
     * this function return all images of the visit
     * @param visitId
    ...
    /**
     * this function search using visit title
     * @param search
     * @return LiveData<List<Visit>>
     */
