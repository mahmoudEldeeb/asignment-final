...
/**
 *  I show all the data of the visit and let user update it
 * @author Areej
 */
public class UpdateVisitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        here I get the object of the visit to show it in fields
         */
        ...
        updateVisitBinding.description.setText(visit.getDescription());
        ...
        updateVisitBinding.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                visit.setDescription(updateVisitBinding.description.getText().toString());
