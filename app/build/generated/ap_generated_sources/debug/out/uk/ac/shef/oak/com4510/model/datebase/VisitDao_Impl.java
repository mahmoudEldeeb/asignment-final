...
public final class VisitDao_Impl implements VisitDao {
  ...
  public VisitDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfVisit = new EntityInsertionAdapter<Visit>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `visit`(`id`,`title`,`description`,`date`,`longitude`,`latitude`,`temp`,`pressure`) VALUES (?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfVisit = new EntityDeletionOrUpdateAdapter<Visit>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `visit` SET `id` = ?,`title` = ?,`description` = ?,`date` = ?,`longitude` = ?,`latitude` = ?,`temp` = ?,`pressure` = ? WHERE `id` = ?";
      }
  ...
  public Long insertVisit(Visit visit) {
    ...
    try {
      long _result = __insertionAdapterOfVisit.insertAndReturnId(visit);
  ...
  public void deleteVisit(Visit visit) {
    __db.beginTransaction();
    try {
      __deletionAdapterOfVisit.handle(visit);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
