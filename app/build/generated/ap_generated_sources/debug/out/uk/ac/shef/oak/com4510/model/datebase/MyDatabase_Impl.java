  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `visit` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` TEXT, `description` TEXT, `date` TEXT, `longitude` REAL NOT NULL, `latitude` REAL NOT NULL, `temp` REAL NOT NULL, `pressure` REAL NOT NULL)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"7de18d332284e85546400a62d10cbd65\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsVisit.put("description", new TableInfo.Column("description", "TEXT", false, 0));
    ...
    }, "7de18d332284e85546400a62d10cbd65", "42a2f5be37333ab435b0128667ddac84");
